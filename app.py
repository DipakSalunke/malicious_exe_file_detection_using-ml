...
def upload_file():
   if request.method == 'POST':
    ...
    features =['Machine', 'SizeOfOptionalHeader', 'Characteristics', 'MajorLinkerVersion', 'ImageBase', 'MajorSubsystemVersion', 'CheckSum', 'Subsystem', 'DllCharacteristics', 'SizeOfStackReserve', 'SectionsNb', 'SectionsMaxEntropy', 'ResourcesMinEntropy', 'ResourcesMaxEntropy', 'VersionInformationSize']
     ##########################################
